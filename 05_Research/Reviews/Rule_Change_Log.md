...
| RCP-v03-008 | `Proposals/RCP-v03-008_Forecast_Framework.md` | 2026-08-09 | forecast/forecast_resolution 对象、开仓/解析/校准语义 | approved | FCT-YYYYMMDD-NNN + RES-YYYYMMDD-NNN 正式对象、open 须 reviewed、到期不可后见修改、resolution criteria 不可变、Brier/calibration 分组 | 0 error；0 warning（无对象变更）|
| RCP-v03-009 | `Proposals/RCP-v03-009_Recommendation_Framework.md` | 2026-08-09 | valuation_snapshot/recommendation 对象、建议等级与人工边界 | approved | VAL-YYYYMMDD-NNN + REC-YYYYMMDD-NNN 正式对象、Company/Security 分离、最高默认 investment_candidate、buy/sell 需另建 RCP、active 人工批准 | 0 error；0 warning（无对象变更）|
...
| RCP-v03-010 | `Proposals/RCP-v03-010_Productization_and_Release_Governance.md` | 2026-08-09 | Dashboard 写边界、Product IA v2、30-day Pilot、v0.3 发布 Gate | approved | Dashboard 只读+loopback、权威写入走 CLI+Markdown、Web mutation 另行批准、IA v2 基线、Pilot 范围固定（D4 Core 54）、发布被 WP-530 阻塞（最早 2026-10-31）、规模化仅按触发、cost 预算入 Health | 0 error；0 warning（无对象变更）|
| RCP-v03-011 | `Proposals/RCP-v03-011_Web_Only_Product_Interface_and_CLI_Retirement.md` | 2026-08-12 | Web-only 产品界面、权威 Web 写入、CLI 退役、人工审批边界 | approved | 网站成为唯一用户界面；Web 继承 preview/confirm/audit/rollback；自动任务仍无审批或 Thesis confidence 修改权；CLI 仅迁移期内部兼容，Web parity 与恢复 Gate 后删除 | F-026 Candidate dismiss 已实施；755 passed/1 skipped；80.66% branch coverage；strict 0/0；F-023 16/21 |
