...
| RCP-v03-011 | `Proposals/RCP-v03-011_Web_Only_Product_Interface_and_CLI_Retirement.md` | 2026-08-12 | Web-only 产品界面、权威 Web 写入、CLI 退役、人工审批边界 | approved | 网站成为唯一用户界面；Web 继承 preview/confirm/audit/rollback；自动任务仍无审批或 Thesis confidence 修改权；CLI 仅迁移期内部兼容，Web parity 与恢复 Gate 后删除 | F-026 Candidate dismiss 已实施；755 passed/1 skipped；80.69% branch coverage；strict 0/0；F-023 16/21 |
