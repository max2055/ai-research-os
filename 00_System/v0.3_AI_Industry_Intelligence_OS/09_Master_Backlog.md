...
`human.release_approval`。WP-530、WP-620、cadence、Known Limitations 阅读确认和
F-024 都不可由工程证据替代；F-023 继续保持 BLOCKED。
...
F-023 证据闭环（2026-08-12，max）：在原 14 条判断上新增
EVT-20260531-049、EVT-20260407-050、EVT-20251003-001、
EVT-20260225-035、EVT-20260430-001、EVT-20260625-001，按原配额完成
20/20；EVT-20260429-046 继续排除，阈值未降低，22 个 Impact Assertion 仍为
pending。两个 arXiv Channel 的 applied recovery run 已与 Job/run metadata 对账并由
max 批准 operational audit。当前 quality suite 与 Dashboard smoke/security 证据记录
在 `v0.3_Release_Gate_Verification_2026-08-12.md`，F-023 为 16/21。
